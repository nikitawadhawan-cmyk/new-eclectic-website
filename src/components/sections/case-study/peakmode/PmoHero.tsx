...
/**
 * PmoHero — hero for the Peak Mode On case-study page. Clones the RitvaaHero
 * design 1:1 (same structure, classes, animations); only the content differs.
 *
 * Big uppercase "AN AYURVEDIC WELLNESS STORE, BUILT TO GUIDE, NOT JUST TO
 * SELL" heading → "— Case Study — Shopify Development —" subhead → a row of
 * three Peak Mode On images (two product shots flanking the lifestyle photo,
...
const HERO_IMAGES: HeroImage[] = [
  {
    ...
    alt: "Peak Mode On Calm Down supplement product shot",
  },
  {
    src: "/figma/pmo-mood.jpg",
    alt: "Peak Mode On lifestyle photo — man running in a park",
    accent: true,
  },
  {
    src: "/figma/pmo-hero-2.jpg",
    alt: "Peak Mode On supplement product shot",
  },
];
...
export default function PmoHero() {
  return (
    <section className="w-full bg-white">
      <div className="mx-auto w-full max-w-[1200px] px-6 py-16 lg:px-10 lg:py-24">
        ...
        <h1 className="text-center font-semibold uppercase text-[#080d0d] text-[40px] leading-[0.95] tracking-[-2px] sm:text-[56px] sm:tracking-[-2.8px] lg:text-[76px] lg:leading-[83.6px] lg:tracking-[-3.8px]">
          An Ayurvedic Wellness Store, Built To Guide, Not Just To Sell
        </h1>
        ...
        <p className="mx-auto mt-10 max-w-[641px] text-center text-[16px] font-normal leading-[24px] tracking-[-0.32px] text-[rgba(33,33,33,0.7)] lg:mt-14">
          Peak Mode On is an authentic Ayurvedic wellness brand offering formulations for better
          sleep, balanced nutrition, and optimal wellness. We built their complete Shopify
          e-commerce platform from the ground up.
        </p>

        {/* View Live Website button */}
        <div className="mt-8 flex justify-center">
          <a
            href="https://www.peakmodeon.com/"
            target="_blank"
