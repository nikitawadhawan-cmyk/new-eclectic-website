/**
 * PmoHighlights — "SERVICES PROVIDED / What drove this project" bento grid
 * (cloned from RitvaaHighlights, itself a 1:1 clone of AmoradaHighlights:
 * redesigned from a supplied dark bento reference, kept on the site's WHITE
 * background per client direction). Content swapped for Peak Mode On.
 *
 ...
 * transitions. Copy is verbatim from the Peak Mode On spec.
 */
...
const CARDS: Card[] = [
  {
    ...
    desc: "Clean, fast, scalable build with custom sections the team can edit.",
  },
  {
  ...
  },
  {
    ...
    desc: "Bespoke Dosha quiz and functionality wired into the buying journey.",
  },
  {
    title: "Product Photography",
    desc: "Art direction and imagery that make each formulation feel premium.",
  },
  {
    title: "Brand Strategy",
    desc: "Positioning the wellness philosophy for a modern D2C audience.",
  },
];
...
export default function PmoHighlights() {
  return (
