...
/**
 * PmoChallenge — "WHY PEAK MODE ON" section for the Peak Mode On case study
 * (clone of RitvaaChallenge / AmoradaChallenge; identical design/structure/
 ...
 *
 * NOTE: the heading "Ancient Wisdom, Modern Storefront" is GLUE text not
 * present in the client's source HTML — needs client review. The subheading
 * is verbatim from the client hero copy.
 *
...
const cards: Card[] = [
  {
    title: "The Challenge",
    body: "Creating an authentic Ayurvedic brand presence online — with educational elements like Dosha identification — while maintaining modern e-commerce functionality that feels effortless to shop.",
    icon: "/figma/am-challenge-puzzle.svg",
    iconSize: "size-7",
  },
  {
    title: "The Solution",
    body: "We built a custom Shopify store with integrated quiz functionality for Dosha identification, beautiful product displays, and educational content that balances traditional Ayurvedic wisdom with contemporary design.",
...
export default function PmoChallenge() {
        ...
        <div className="mx-auto flex max-w-[900px] flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            <h2 className="text-[34px] font-semibold leading-[1.1] tracking-[-1.6px] text-[#1a1a1a] sm:text-[46px] sm:tracking-[-2.2px] lg:text-[64px] lg:leading-[72px] lg:tracking-[-3.6px]">
              Ancient Wisdom, Modern Storefront
            </h2>
            <p className="max-w-[640px] text-[16px] font-normal leading-[1.5] tracking-[-0.4px] text-black/60 lg:text-[18px] lg:tracking-[-0.48px]">
              Peak Mode On is an authentic Ayurvedic wellness brand offering
              formulations for better sleep, balanced nutrition, and optimal
              wellness.
            </p>
          </div>
        </div>
