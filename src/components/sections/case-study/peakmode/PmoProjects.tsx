...
/**
 * PmoProjects — "MORE WORK" project showcase on the Peak Mode On case-study
 * page. Clone of RitvaaProjects (itself a 1:1 clone of AmoradaProjects,
 * Figma: file Gf61npUa7cN0kaGb5RgSwe, node 203:1293) with Peak Mode On
 ...
 * then TWO project blocks (Ritvaa, amorada). Each block: title, two
 ...
 *
 * DEVIATIONS from the client HTML (flagged):
 *   - The HTML's second card was "HDFC Life" — no such case-study page
 *     exists, so it is replaced with amorada per spec.
 *   - Both blocks link to REAL case-study routes (/projects/ritvaa,
 *     /projects/amorada) — title and round arrow button are wrapped in
 *     next/link Links (house pattern; basePath handled automatically).
 *   - Ritvaa stat-chip labels ("Jewellery", "Buyback Guarantee") are glue
 *     copy not in the client HTML — kept exactly as written in the spec.
 */
...
export default function PmoProjects() {
  return (
    <section
      aria-labelledby="pmo-projects-heading"
