/**
 * PmoCTA — "Ready For Similar Results?" CTA on the Peak Mode On case-study
 * page. Clone of RitvaaCTA (itself a clone of AmoradaCTA, Figma node
 * 216:4845) with Peak Mode On content.
 *
 ...
 * public/figma/pmo-edu.jpg laid as an absolutely-positioned <img>
 * with the navy tint + live text over it. Uses assetPath() for the raw
 * <img> (GitHub Pages basePath).
 *
 * DEVIATIONS (flagged in report):
 *  - No photo-grid collage asset exists for Peak Mode On (amorada uses
 *    am-cta-collage.jpg); a single photo (pmo-edu.jpg) sits under the
...
export default function PmoCTA() {
  return (
    <section className="w-full py-8 lg:py-12">
      <div className="mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-10">
        <div className="relative overflow-hidden rounded-[28px] lg:rounded-[47px]">
          {/* Background photo (single wide strip — no collage asset for Peak Mode On) */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src={assetPath("/figma/pmo-edu.jpg")}
            alt=""
            aria-hidden="true"
