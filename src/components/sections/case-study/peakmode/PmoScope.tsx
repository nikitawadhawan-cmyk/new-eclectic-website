...
/**
 * PmoScope — "WHAT WE DID" keyline ledger (cloned from RitvaaScope, itself a
 * 1:1 clone of AmoradaScope: row styling + animation from the "Project
 * Drivers 3c" standalone HTML, recolored onto the site's white bg with the
 * brand navy as the accent). Content swapped for Peak Mode On.
 *
...
const ROWS: ScopeRow[] = [
  {
    ...
    description:
      "Mapped the Ayurvedic philosophy into a homepage narrative and a clear buying journey for first-time wellness shoppers.",
  },
  {
    title: "Dosha quiz integration",
    description:
      "Designed and built a guided quiz that identifies the buyer's Dosha and recommends the right formulations.",
  },
  {
    title: "Educational content",
    description:
      "Wove traditional Ayurvedic wisdom into the store so buyers learn as they browse — sleep, nutrition, wellness.",
  },
  {
    title: "Product & catalogue setup",
    description:
      "Structured the full catalogue with beautiful, detail-rich product displays and photography direction.",
  },
  {
    title: "Shopify build",
    description:
      "Custom, mobile-first theme with editable sections — fast, scalable, and easy for the team to run.",
  },
  {
    title: "Launch & handover",
    description:
      "Went live with tracking in place, plus training so Peak Mode On can grow the store independently.",
  },
];
...
export default function PmoScope() {
      ...
      <div className="mx-auto w-full max-w-[1200px] px-6 lg:px-10">
        ...
        <div className="flex flex-col items-center gap-5 text-center lg:gap-6">
          ...
          <h2 className="max-w-[848px] text-balance text-[40px] font-semibold leading-[1.05] tracking-[-0.03em] text-black sm:text-[56px] lg:text-[76px] lg:leading-[83.6px] lg:tracking-[-3.8px]">
            From Philosophy To A Store That Ships
          </h2>

          <p className="max-w-[864px] text-[16px] leading-[1.4] text-muted lg:leading-[22.4px]">
            From discovery and positioning to launch and handover — the full
            build, end to end.
          </p>
        </div>
