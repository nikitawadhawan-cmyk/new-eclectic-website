...
/**
 * RitvaaChallenge — "WHY RITVAA" section for the Ritvaa case study
 * (clone of AmoradaChallenge; identical design/structure/classes/animation,
 * Ritvaa content per .figma-to-website/ritvaa-case-study/spec.md):
 *
 ...
 *
 * NOTE: the heading "Luxury That Had To Earn Trust Online" is GLUE text not
...
const cards: Card[] = [
  {
    title: "The Challenge",
    body: "Creating a luxury jewellery e-commerce experience that conveys trust, tradition, and the unique value proposition of a lifetime buyback for SmartGold.",
    icon: "/figma/am-challenge-puzzle.svg",
    iconSize: "size-7",
  },
  {
    title: "The Solution",
    body: "We designed an elegant Shopify platform that balances modern e-commerce functionality with traditional jewellery-shopping expectations — with special emphasis on showcasing the lifetime buyback guarantee and product authenticity.",
...
export default function RitvaaChallenge() {
