...
/**
 * RitvaaResults — "The Results" spotlight-split for the Ritvaa case study
 * (clone of AmoradaResults; identical design/structure/classes/animation,
 ...
 *    achieved") and supporting line ("The rebuild focused on three things —
 *    and delivered all three.") are GLUE text not present in the client's
 ...
 *
 * Palette: brand navy #2a315f (bg-navy), brand gold #e8c700. Card titles are
 * the client HTML's results labels; descriptions reuse real sentences from
 * its steps/services.
 */
...
const RESULTS: Result[] = [
  {
    ...
    desc: "An elegant, tradition-meets-modern visual language with premium, detail-rich product displays.",
  },
  {
    kicker: "02 · PREMIUM",
    title: "Product Display",
    desc: "Detail-rich, zoomable displays that make fine jewellery feel tangible.",
  },
  {
    kicker: "03 · HIGHLIGHTED",
    title: "Trust Features",
    desc: "Buyback guarantee, authenticity cues and reassurance across the journey.",
  },
];

export default function RitvaaResults() {
      ...
      <div className="mx-auto grid w-full max-w-[1200px] grid-cols-1 items-start gap-12 px-6 lg:grid-cols-[minmax(280px,360px)_1fr] lg:gap-[clamp(40px,5vw,72px)] lg:px-10">
        ...
        <div className="flex flex-col gap-6 lg:sticky lg:top-[100px]">
          ...
          <h2 className="text-pretty font-semibold leading-[1.15] tracking-[-0.6px] text-[#0e1330] text-[32px] lg:text-[44px]">
            What the new store achieved
          </h2>
          <p className="max-w-[36ch] text-pretty text-[16px] leading-[1.6] text-[#6b7086]">
            The rebuild focused on three things &mdash; and delivered all
            three.
          </p>
        </div>
