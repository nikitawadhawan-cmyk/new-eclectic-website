...
/**
 * RitvaaStats — Ritvaa case study, two stacked bands. Clones the AmoradaStats
...
type Stat = {
  ...
  value: string;
  /** true when a gold "+" follows the value — no Ritvaa stat uses it. */
  plus?: boolean;
  label: string;
};
...
export default function RitvaaStats() {
  return (
    <section aria-labelledby="ritvaa-stats-heading" className="w-full bg-white">
      <div className="mx-auto w-full max-w-[1200px] px-6 py-16 lg:px-10 lg:py-24">
        ...
        <figure className="mt-20 flex w-full flex-col items-center gap-6 text-center lg:mt-32">
          ...
          <blockquote className="mx-auto w-full max-w-[1065px] text-[#0a0a0a] text-[26px] leading-[36px] tracking-[-0.4px] sm:text-[32px] sm:leading-[46px] lg:text-[40px] lg:leading-[56px] lg:tracking-[-0.6px]">
            A store that finally sells the way fine jewellery deserves &mdash; on
            trust, and on tradition.
          </blockquote>
