...
/**
 * RitvaaHero — hero for the Ritvaa case-study page. Clones the AmoradaHero
 * design 1:1 (same structure, classes, animations); only the content differs.
 *
 * Big uppercase "LUXURY SMARTGOLD JEWELLERY, SOLD ON TRUST" heading → "— Case
 * Study — Shopify Development —" subhead → a row of three Ritvaa images (two
 * product shots flanking the lifestyle banner, which is framed with violet
...
export default function RitvaaHero() {
  return (
    <section className="w-full bg-white">
      <div className="mx-auto w-full max-w-[1200px] px-6 py-16 lg:px-10 lg:py-24">
        ...
        <h1 className="text-center font-semibold uppercase text-[#080d0d] text-[40px] leading-[0.95] tracking-[-2px] sm:text-[56px] sm:tracking-[-2.8px] lg:text-[76px] lg:leading-[83.6px] lg:tracking-[-3.8px]">
          Luxury SmartGold Jewellery, Sold On Trust
        </h1>
        ...
        <p className="mx-auto mt-10 max-w-[641px] text-center text-[16px] font-normal leading-[24px] tracking-[-0.32px] text-[rgba(33,33,33,0.7)] lg:mt-14">
          Ritvaa offers SmartGold jewellery with a lifetime buyback guarantee. We developed their
          elegant e-commerce platform showcasing their mangalsutra and jewellery collections with a
          focus on trust and tradition.
        </p>

        {/* View Live Website button */}
        <div className="mt-8 flex justify-center">
          <a
            href="https://ritvaa.in/"
            target="_blank"
