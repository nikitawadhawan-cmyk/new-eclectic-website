/**
 * RitvaaHighlights — "SERVICES PROVIDED / What drove this project" bento grid
 * (cloned from AmoradaHighlights: redesigned from a supplied dark bento
 ...
 * transitions. Copy is verbatim from the Ritvaa spec.
 */
...
const CARDS: Card[] = [
  {
    ...
    desc: "A clean, fast, scalable build with custom sections the team can edit.",
  },
  {
    title: "Luxury E-commerce Design",
    desc: "A bespoke, premium storefront that honours heritage and reads modern.",
  },
  {
  ...
  },
  {
    ...
    desc: "A full catalogue structured by occasion, style and price for easy browsing.",
  },
];
...
export default function RitvaaHighlights() {
  return (
