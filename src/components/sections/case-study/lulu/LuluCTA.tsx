/**
 * LuluCTA — "Ready For Similar Results?" CTA. Clones the AmoradaCTA design
 * 1:1 (same generic agency-facing copy used across the whole clone family);
 * background is a real Lulu & Daisy lifestyle photo (lulu-testi.jpg).
 */
...
export default function LuluCTA() {
  return (
    <section className="w-full py-8 lg:py-12">
      <div className="mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-10">
        <div className="relative overflow-hidden rounded-[28px] lg:rounded-[47px]">
          ...
          <img
            src={assetPath("/figma/lulu-testi.jpg")}
            alt=""
            aria-hidden="true"
