...
/**
 * IvyResults — "The Results" spotlight-split for the Ivylistic case study
 ...
 *    heading, supporting line. NOTE: the heading ("What the brand site
 *    delivers") and supporting line ("Narrative, frameworks, and conversion
 *    — working as one.") are GLUE text not present in the client's source
 *    HTML — needs client review.
 ...
 * verbatim from the spec (curly quotes kept).
 */
...
const RESULTS: Result[] = [
  {
    kicker: "01 · BRAND NARRATIVE",
    title: "Strategy-Led",
    desc: "Wrote a mentor-led voice — “we've sat where you sit” — that reassures high-stakes applicants.",
  },
  {
    kicker: "02 · FREE EVALUATION",
    title: "Lead-Focused",
    desc: "Built a frictionless free profile evaluation with a 24-hour response promise as the primary conversion.",
  },
  {
    kicker: "03 · TRUST SIGNALS",
    title: "Alumni-Backed",
    desc: "Designed an interactive map of admits across the world's top programs as living proof.",
  },
];

export default function IvyResults() {
      ...
      <div className="mx-auto grid w-full max-w-[1200px] grid-cols-1 items-start gap-12 px-6 lg:grid-cols-[minmax(280px,360px)_1fr] lg:gap-[clamp(40px,5vw,72px)] lg:px-10">
        ...
        <div className="flex flex-col gap-6 lg:sticky lg:top-[100px]">
          ...
          <h2 className="text-pretty font-semibold leading-[1.15] tracking-[-0.6px] text-[#0e1330] text-[32px] lg:text-[44px]">
            What the brand site delivers
          </h2>
          <p className="max-w-[36ch] text-pretty text-[16px] leading-[1.6] text-[#6b7086]">
            Narrative, frameworks, and conversion &mdash; working as one.
          </p>
        </div>
