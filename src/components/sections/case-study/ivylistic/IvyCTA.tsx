/**
 * IvyCTA — "Ready For Similar Results?" CTA on the Ivylistic case-study
 * page. Clone of RitvaaCTA (itself cloned from AmoradaCTA, Figma node
 * 216:4845) with Ivylistic content.
 *
 ...
 *
 * ASSET APPROACH: background is the SINGLE campus photo
 * public/figma/ivy-og.jpg (brand card, reads as subtle texture under the tint) laid as an absolutely-positioned <img>
 * with the navy tint + live text over it. Uses assetPath() for the raw
 * <img> (GitHub Pages basePath).
 *
 * DEVIATIONS (flagged in report):
 *  - Spec suggested /figma/ivy-3.jpg as the background, but on visual
 *    inspection ivy-3.jpg is a face-forward portrait of a woman — per spec
 *    instruction, and ivy-oxford.jpg turned out to be a chat screenshot, the brand card (ivy-og.jpg) is used instead — flagged.
 *  - No photo-grid collage asset exists for Ivylistic (amorada uses
 *    am-cta-collage.jpg); a single photo sits under the same navy tint
 *    instead, per spec.
...
export default function IvyCTA() {
  return (
    <section className="w-full py-8 lg:py-12">
      <div className="mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-10">
        <div className="relative overflow-hidden rounded-[28px] lg:rounded-[47px]">
          {/* Background photo (Oxford campus — ivy-3.jpg is a portrait, swapped per spec) */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src={assetPath("/figma/ivy-og.jpg")}
            alt=""
            aria-hidden="true"
