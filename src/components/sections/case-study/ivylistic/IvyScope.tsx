...
/**
 * IvyScope — "WHAT WE DID" keyline ledger (cloned from RitvaaScope: row
 ...
 * and descriptions are verbatim from the spec (curly quotes and ™ kept).
 */
...
const ROWS: ScopeRow[] = [
  {
    ...
    description:
      "Sharpened the “strategy, not guesswork” promise into a brand story that separates Ivylistic from generic consultants.",
  },
  {
    title: "Brand narrative & messaging",
    description:
      "Wrote a mentor-led voice — “we've sat where you sit” — that reassures high-stakes applicants.",
  },
  {
    title: "Framework storytelling",
    description:
      "Made the Candidate Canvas™ and 5C positioning framework visible, so the methodology sells itself.",
  },
  {
    title: "Global network map",
    description:
      "Designed an interactive map of admits across the world's top programs as living proof.",
  },
  {
    title: "Lead generation",
    description:
      "Built a frictionless free profile evaluation with a 24-hour response promise as the primary conversion.",
  },
  {
    title: "Build & launch",
    description:
      "Developed a fast, responsive site with clean information architecture across MBA, MiM and MS tracks.",
  },
];
...
export default function IvyScope() {
      ...
      <div className="mx-auto w-full max-w-[1200px] px-6 lg:px-10">
        ...
        <div className="flex flex-col items-center gap-5 text-center lg:gap-6">
          ...
          <p className="max-w-[864px] text-[16px] leading-[1.4] text-muted lg:leading-[22.4px]">
            From discovery and positioning to build and launch — the full
            brand site, end to end.
          </p>
        </div>
