/**
 * IvyHighlights — "SERVICES PROVIDED / What drove this project" bento grid
 ...
 * transitions. Copy is verbatim from the Ivylistic spec (curly quotes kept).
 */
...
const CARDS: Card[] = [
  {
    ...
    desc: "A confident, mentor-led brand experience across every track.",
  },
  {
    title: "Website Development",
    desc: "A fast, responsive build with clean, scalable architecture.",
  },
  {
    title: "Brand Strategy",
    desc: "Positioning “strategy, not guesswork” against a crowded field.",
  },
  {
    title: "Lead Generation",
    desc: "A frictionless free-evaluation flow as the primary conversion.",
  },
  {
    title: "Content Structure",
    desc: "MBA, MiM and MS journeys organised for clarity and trust.",
  },
];
...
export default function IvyHighlights() {
  return (
