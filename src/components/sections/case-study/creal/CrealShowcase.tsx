...
/**
 * CrealShowcase — device showcase band. Clones the RitvaaShowcase pattern
 * (no pre-composited laptop+phone photo export exists for CREAL, so this is
 * a CSS-built device mockup) showing the real CREAL homepage banner
 * (creal-hero-1.jpg — "Discover Timeless Elegance", verified against the
 * live site) on a laptop with a phone beside it.
 */
function DeviceMockup() {
  const screen = "/figma/creal-hero-1.jpg";
  const alt = "The CREAL homepage — Discover Timeless Elegance, Crafted in Gold & Diamonds";
...
export default function CrealShowcase() {
  return (
