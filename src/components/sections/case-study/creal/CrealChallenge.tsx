...
/**
 * CrealChallenge — "WHY CREAL" section. Clones the AmoradaChallenge design
 * 1:1 (pointer-following spotlight, defaults to "The Solution"); copy from
 * the "Challenge + Solution" section of the client's brief.
 *
...
const cards: Card[] = [
  {
    title: "The Challenge",
    body: "Run a 500+ SKU fine-jewellery storefront where high-consideration buyers need to find the exact piece fast — and feel confident enough to complete a considered purchase online.",
    icon: "/figma/am-challenge-puzzle.svg",
    iconSize: "size-7",
  },
  {
    title: "The Solution",
    body: "A complete Shopify storefront with category-led navigation, six-facet smart filtering, a PIN-code delivery estimator on the product page, and conversion features — offers and low-stock urgency.",
...
export default function CrealChallenge() {
        ...
        <div className="mx-auto flex max-w-[900px] flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            <h2 className="text-[34px] font-semibold leading-[1.1] tracking-[-1.6px] text-[#1a1a1a] sm:text-[46px] sm:tracking-[-2.2px] lg:text-[64px] lg:leading-[72px] lg:tracking-[-3.6px]">
              From Big Catalogue To Considered Purchase
            </h2>
            <p className="max-w-[640px] text-[16px] font-normal leading-[1.5] tracking-[-0.4px] text-black/60 lg:text-[18px] lg:tracking-[-0.48px]">
              CREAL is a fine jewellery destination for engagement, bridal
              and everyday pieces in gold and diamonds — with 500+ SKUs to
              navigate.
            </p>
          </div>
        </div>
