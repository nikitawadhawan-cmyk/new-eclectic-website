...
/**
 * CrealResults — "The Results" spotlight-split. Clones the AmoradaResults
 * design 1:1; content from the "Results" section of the client's brief
 * (Smart Filtering / Delivery Estimator / Bridal Sets cards).
 */
...
const RESULTS: Result[] = [
  {
    kicker: "01 · SMART FILTERING",
    title: "Six Facets",
    desc: "Metal, colour, ring size, occasion and more — six-facet filtering turns a 500+ SKU catalogue into a fast, guided path to the right piece.",
  },
  {
    kicker: "02 · DELIVERY ESTIMATOR",
    title: "PIN-Code ETA",
    desc: "A delivery estimator on the product page answers 'when will it arrive?' upfront, building the confidence high-consideration buyers need to act.",
  },
  {
    kicker: "03 · ENGAGEMENT & BRIDAL",
    title: "Bridal Sets",
    desc: "Dedicated engagement and bridal collections give shoppers a considered path to the pieces that matter most.",
  },
];

export default function CrealResults() {
      ...
      <div className="mx-auto grid w-full max-w-[1200px] grid-cols-1 items-start gap-12 px-6 lg:grid-cols-[minmax(280px,360px)_1fr] lg:gap-[clamp(40px,5vw,72px)] lg:px-10">
        <div className="flex flex-col gap-6 lg:sticky lg:top-[100px]">
          ...
          <h2 className="text-pretty font-semibold leading-[1.15] tracking-[-0.6px] text-[#0e1330] text-[32px] lg:text-[44px]">
            Three features that turn browsing into buying
          </h2>
          <p className="max-w-[36ch] text-pretty text-[16px] leading-[1.6] text-[#6b7086]">
            A 500+ SKU catalogue is only as good as the path it gives a
            shopper to the one piece they actually want.
          </p>
        </div>
