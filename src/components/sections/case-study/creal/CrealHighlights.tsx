/**
 * CrealHighlights — "SERVICES PROVIDED" bento grid. Clones the
...
const CARDS: Card[] = [
  {
    ...
    desc: "A complete, custom-built storefront for a large jewellery catalogue.",
  },
  {
    title: "Catalogue Management",
    desc: "500+ SKUs structured across every category and collection.",
  },
  {
    title: "Custom Filtering",
    desc: "Six-facet smart filtering to find the exact piece, fast.",
  },
  {
    title: "Conversion Optimization",
    desc: "Delivery ETA, offers and low-stock urgency tuned to convert.",
  },
  {
    title: "Storefront Operations",
    desc: "Ongoing merchandising and product-page enhancements.",
  },
];
...
export default function CrealHighlights() {
  return (
    <section className="w-full bg-white py-20 lg:py-24">
      <div className="mx-auto w-full max-w-[1200px] px-6 lg:px-10">
        ...
        <h2 className="mt-6 text-center text-[36px] font-semibold leading-[1.1] tracking-[-1px] text-ink lg:text-[54px] lg:tracking-[-1.6px]">
          Everything behind the CREAL storefront
        </h2>
