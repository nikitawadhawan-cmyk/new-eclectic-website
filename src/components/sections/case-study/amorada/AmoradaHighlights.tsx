/**
 * AmoradaHighlights — "SERVICES PROVIDED / What drove this project" bento grid
 * (redesigned from a supplied dark bento reference, kept on the site's WHITE
 * background per client direction).
 *
 ...
 * shadow) and turns the brand navy — number flips to gold, text to white —
 * with smooth 300ms transitions. Copy is verbatim from the reference.
 */
...
const CARDS: Card[] = [
  {
    ...
    desc: "A clean, fast, scalable build with editable, on-brand sections.",
  },
  {
    title: "E-commerce Design",
    desc: "A warm, editorial storefront that foregrounds craft and texture.",
  },
  {
    title: "Product Merchandising",
    desc: "A broad catalogue organised by room and by colour palette.",
  },
  {
    title: "Brand Strategy",
    desc: "Positioning “comfort meets craft” across every category.",
  },
  {
    title: "Conversion Optimization",
    desc: "Offers, bestsellers and a prepaid/COD checkout tuned to convert.",
  },
];
...
export default function AmoradaHighlights() {
  return (
