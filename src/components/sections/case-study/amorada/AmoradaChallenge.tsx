...
/**
 * AmoradaChallenge — "WHY AMORADA" section (Figma node 218:5125), with the
 * spotlight interaction from the page's "The Results" section applied at
 * client request:
 *
 ...
 * with 0.4s ease transitions. Defaults to "The Solution", matching the card
 * the Figma originally emphasized (white + gold border, kept as its idle
 * state).
 *
 * Icons are clean single-SVG Figma exports (gold fill baked in):
...
const cards: Card[] = [
  {
    title: "The Challenge",
    body: "Sell tactile, texture-led home linens online — where buyers want to feel the fabric — and organise a broad catalogue, from bedding to cutlery, so it's easy and inspiring to shop.",
    icon: "/figma/am-challenge-puzzle.svg",
    iconSize: "size-7",
  },
  {
    title: "The Solution",
    body: "A warm, editorial Shopify store that foregrounds craftsmanship and texture, organises products by room and by colour palette, and offers a frictionless checkout with both prepaid and COD.",
...
export default function AmoradaChallenge() {
        ...
        <div className="mx-auto flex max-w-[900px] flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            <h2 className="text-[34px] font-semibold leading-[1.1] tracking-[-1.6px] text-[#1a1a1a] sm:text-[46px] sm:tracking-[-2.2px] lg:text-[64px] lg:leading-[72px] lg:tracking-[-3.6px]">
              From Beautiful Ideas To Beautiful Homes
            </h2>
            <p className="max-w-[640px] text-[16px] font-normal leading-[1.5] tracking-[-0.4px] text-black/60 lg:text-[18px] lg:tracking-[-0.48px]">
              Thoughtfully crafted home linens and décor that bring warmth,
              comfort, and timeless elegance to every space.
            </p>
          </div>
        </div>
