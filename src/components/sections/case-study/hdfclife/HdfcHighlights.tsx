/**
 * HdfcHighlights — "SERVICES PROVIDED / What drove this project" bento grid
 ...
 * transitions. Copy is verbatim from the HDFC Life spec.
 */
...
const CARDS: Card[] = [
  {
    ...
    desc: "A single-purpose page designed end to end for one clear action.",
  },
  {
    title: "Conversion Optimization",
    desc: "Layout, hierarchy and form flow tuned for first-visit completion.",
  },
  {
    title: "Performance Marketing",
    desc: "A page built to be measured — every click accountable to a lead.",
  },
  {
    title: "Lead Generation",
    desc: "A stripped-down form that turns awareness traffic into applicants.",
  },
  {
    title: "Best of Social Media",
    desc: "Creative and messaging aligned with the campaigns driving traffic.",
  },
];
...
export default function HdfcHighlights() {
  return (
