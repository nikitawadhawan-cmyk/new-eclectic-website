/**
 * HdfcCTA — "Ready For Similar Results?" CTA on the HDFC Life case-study
 * page. Clone of RitvaaCTA (itself a clone of AmoradaCTA, Figma node
 * 216:4845) with HDFC Life content.
 *
 ...
 *
 * ASSET APPROACH: background is the SINGLE illustration
 * public/figma/hdfc-og.jpg laid as an absolutely-positioned <img>
 * with the navy tint + live text over it. Uses assetPath() for the raw
 * <img> (GitHub Pages basePath).
 *
 * DEVIATIONS (flagged in report):
 *  - Background image hdfc-og.jpg is REUSED from the hero centre slot —
 *    no dedicated CTA collage/photo asset exists for HDFC Life; the
 *    family-under-umbrella illustration sits under the same navy tint
 *    instead, per spec.
...
export default function HdfcCTA() {
  return (
    <section className="w-full py-8 lg:py-12">
      <div className="mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-10">
        <div className="relative overflow-hidden rounded-[28px] lg:rounded-[47px]">
          {/* Background illustration (hdfc-og.jpg — reused from the hero centre) */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src={assetPath("/figma/hdfc-og.jpg")}
            alt=""
            aria-hidden="true"
