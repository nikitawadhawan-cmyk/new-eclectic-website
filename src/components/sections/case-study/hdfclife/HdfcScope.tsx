...
/**
 * HdfcScope — "WHAT WE DID" keyline ledger (cloned from RitvaaScope: row
...
const ROWS: ScopeRow[] = [
  {
    ...
    description:
      "Distilled the “become an HDFC Life agent” pitch into one eye-catching headline and value proposition.",
  },
  {
    title: "Above-the-fold design",
    description:
      "Led with high-quality imagery and a clear explanation of what agents do — right where attention peaks.",
  },
  {
    title: "Form reduction",
    description:
      "Pared the form down to only the fields needed to start a conversation, so completion takes under a minute.",
  },
  {
    title: "Visual hierarchy",
    description:
      "Directed the eye from headline to benefit to form with a deliberate, single-path layout.",
  },
  {
    title: "Conversion build",
    description:
      "Built the page fast and mobile-first, with the form and CTA engineered for first-visit submission.",
  },
  {
    title: "Performance & tracking",
    description:
      "Wired up lead tracking so every campaign click could be measured against qualified applications.",
  },
];
...
export default function HdfcScope() {
      ...
      <div className="mx-auto w-full max-w-[1200px] px-6 lg:px-10">
        ...
        <div className="flex flex-col items-center gap-5 text-center lg:gap-6">
          ...
          <h2 className="max-w-[848px] text-balance text-[40px] font-semibold leading-[1.05] tracking-[-0.03em] text-black sm:text-[56px] lg:text-[76px] lg:leading-[83.6px] lg:tracking-[-3.8px]">
            Engineered For A Single Conversion
          </h2>

          {/* (glue) supporting line — connective copy, needs client review */}
          <p className="max-w-[864px] text-[16px] leading-[1.4] text-muted lg:leading-[22.4px]">
            From positioning and message to performance tracking — the full
            page, end to end.
          </p>
        </div>
