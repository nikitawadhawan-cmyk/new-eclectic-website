...
/**
 * HdfcProjects — "MORE WORK" project showcase on the HDFC Life case-study
 * page. Clone of RitvaaProjects (itself a clone of AmoradaProjects, Figma:
 * file Gf61npUa7cN0kaGb5RgSwe, node 203:1293) with HDFC Life-specific
 ...
 * then TWO project blocks (Peak Mode On, Ritvaa). Each block: title, two
 ...
 *
 * DEVIATIONS from the source HTML (flagged):
 *   - Stat-chip labels on BOTH blocks are glue copy not present in the
 *     client HTML — Peak Mode On "Full Store / Ground-Up Build" +
 *     "Dosha Quiz / Custom Integration", Ritvaa "SmartGold / Jewellery" +
 *     "Lifetime / Buyback Guarantee" — kept exactly as written in the spec.
 *   - Both blocks link to REAL case-study routes (/projects/peak-mode-on,
 *     /projects/ritvaa) — title and round arrow button are wrapped in
 *     next/link Links (house pattern; basePath handled automatically).
 *   - All images pre-exist in public/figma/ (nothing downloaded); alts are
 *     written from the images' actual content. Note pmo-banner.jpg is an
 *     office/team scene, not a product shot — alt reflects what is shown.
 */
...
const PROJECTS: Project[] = [
  {
    ...
    year: "2026",
    main: "/figma/pmo-banner.jpg",
    mainAlt:
      "Peak Mode On banner — team gathered around screens in a modern office",
    thumbs: [
      {
        src: "/figma/pmo-hero-1.jpg",
        alt: "Peak Mode On Calm Down — Ayurvedic calming supplement jar and canister",
      },
      {
        src: "/figma/pmo-hero-2.jpg",
        alt: "Peak Mode On Good Night — Ayurvedic sleep supplement jar and canister",
      },
    ],
    description:
      "A complete Ayurvedic wellness store with a custom Dosha quiz.",
    stats: [
      { value: "Full Store", label: "Ground-Up Build" },
      { value: "Dosha Quiz", label: "Custom Integration" },
    ],
  },
  {
    title: "Ritvaa",
...
export default function HdfcProjects() {
  return (
    <section
      aria-labelledby="hdfc-projects-heading"
