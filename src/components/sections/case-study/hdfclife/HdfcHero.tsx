...
/**
 * HdfcHero — hero for the HDFC Life case-study page. Clones the RitvaaHero
 * design 1:1 (same structure, classes, animations); only the content differs.
 *
 * Big uppercase "A LANDING PAGE THAT TURNS TRAFFIC INTO AGENTS" heading →
 * "— Case Study — Performance Marketing —" subhead → a row of three HDFC Life
 * images (two campaign banners flanking the family-under-umbrella
 * illustration, which is framed with violet corner brackets, per the amorada
 * design) → intro paragraph → navy "View Live Website" pill button with a
 * circular arrow badge.
 *
 * !!! PLACEHOLDER URL !!! The "View Live Website" button currently points to
 * https://www.hdfclife.com/ — the actual campaign landing-page URL is coming
 * from the client and MUST be swapped in when received. Do not ship this as
 * final without confirming the destination.
 *
 * The flanking banners are text-heavy campaign creatives (1600×585) with copy
 * on the left and the lifestyle photo on the right — both crops are anchored
 * `object-right` so the narrow hero frame lands on the photo side.
 *
...
type HeroImage = {
  ...
  alt: string;
  accent?: boolean;
  /** Extra img classes (e.g. crop anchoring for the very wide banner exports). */
  imgClassName?: string;
};

const HERO_IMAGES: HeroImage[] = [
  {
    src: "/figma/hdfc-banner-2.jpg",
    alt: "HDFC Life Sanchay Aajeevan campaign banner — family reading together at home, beside the headline “You’ve worked hard all your life — now let your money do the same”",
    imgClassName: "object-right",
  },
  {
    src: "/figma/hdfc-og.jpg",
    alt: "HDFC Life illustration — a family sheltered under a large blue umbrella, with a life-insurance checklist, protection shield and growing rupee savings around them",
    accent: true,
  },
  {
    src: "/figma/hdfc-banner-3.jpg",
    alt: "HDFC Life Smart Pension Plan campaign banner — man in a suit reviewing a wall chart, beside the headline “Leverage untapped opportunities for greater value”",
    imgClassName: "object-right",
  },
];
...
export default function HdfcHero() {
  return (
    <section className="w-full bg-white">
      <div className="mx-auto w-full max-w-[1200px] px-6 py-16 lg:px-10 lg:py-24">
        ...
        <h1 className="text-center font-semibold uppercase text-[#080d0d] text-[40px] leading-[0.95] tracking-[-2px] sm:text-[56px] sm:tracking-[-2.8px] lg:text-[76px] lg:leading-[83.6px] lg:tracking-[-3.8px]">
          A Landing Page That Turns Traffic Into Agents
        </h1>
        ...
        <p className="mx-auto mt-10 max-w-[641px] text-center text-[16px] font-normal leading-[24px] tracking-[-0.32px] text-[rgba(33,33,33,0.7)] lg:mt-14">
          HDFC Life needed a page that could turn awareness traffic into qualified agent leads. We
          designed and built a single-purpose page with strong visuals, a clear value proposition,
          and a stripped-down form anyone could complete in under a minute.
        </p>

        {/* View Live Website button — PLACEHOLDER URL, see docblock */}
