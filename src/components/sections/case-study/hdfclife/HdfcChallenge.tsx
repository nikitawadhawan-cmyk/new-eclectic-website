...
/**
 * HdfcChallenge — "THE OBJECTIVE" section for the HDFC Life case study
 ...
 *
 * NOTE: the heading "One Page, One Job" is GLUE text not present in the
 * client's source HTML — needs client review. The subheading is verbatim
 * from the HTML's Objective panel. The pill on this page reads
 * "THE OBJECTIVE" (not "Why <client>").
 *
...
const cards: Card[] = [
  {
    title: "The Challenge",
    body: "Convincing prospective insurance agents to fill out a form on their first visit — against a category that traditionally relies on long-form sales pitches and in-person meetings.",
    icon: "/figma/am-challenge-puzzle.svg",
    iconSize: "size-7",
  },
  {
    title: "The Solution",
    body: "The page led with high-quality imagery and a single eye-catching headline. We explained what agents do and the advantages of working with HDFC Life directly above the fold, and pared the form down to only the fields needed to start a conversation.",
...
export default function HdfcChallenge() {
        ...
        <div className="mx-auto flex max-w-[900px] flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="max-w-[640px] text-[16px] font-normal leading-[1.5] tracking-[-0.4px] text-black/60 lg:text-[18px] lg:tracking-[-0.48px]">
              Build a page that explains what agents do and the advantages of
              partnering with HDFC Life &mdash; then convert visitors into
              agent applicants via a simple form.
            </p>
          </div>
        </div>
