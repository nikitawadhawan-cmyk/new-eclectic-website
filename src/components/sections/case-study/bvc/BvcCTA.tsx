/**
 * BvcCTA — "Ready For Similar Results?" CTA. Clones the AmoradaCTA design 1:1
 * (same generic agency-facing copy used across the whole clone family);
 * background reuses the BVC-specific photo collage the old bespoke CaseCTA
 * shipped (cs-cta-collage.jpg).
 */
