 ...
 *
 * (a) STATS BAND — Figma 4-up stat grid (amorada 221-5847): heading
 *     "Numbers that speak", then four hairline-topped cells (52px bold value,
 *     gold "+" suffix, 16px label). 4-up desktop → 2-up tablet → 1-up mobile.
 *     Facts: 200+ pages planned, 18+ user flows, 150+ content sections,
 *     2 Months duration.
...
export default function BvcStats() {
  return (
    <section aria-labelledby="bvc-stats-heading" className="w-full bg-white">
