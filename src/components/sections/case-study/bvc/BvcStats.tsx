...
/**
 * BvcStats — BVC Logistics case study, two stacked bands.
 *
 * (a) STATS BAND — cascading editorial layout (replaces the old 4-up grid):
 *     a giant faint background numeral pulled from the headline KPI, three
 *     stat rows of decreasing size and increasing indent (the 2nd row in a
 *     navy→gold gradient), then a compact monospace meta line with all four
 *     facts. Same 4 facts as before: 200+ pages planned, 18+ user flows,
 *     150+ content sections, 2 Months duration — only the layout changed.
