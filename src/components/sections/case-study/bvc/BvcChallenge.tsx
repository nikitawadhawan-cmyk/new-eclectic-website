...
/**
 * BvcChallenge — "WHY BVC" section. Clones the AmoradaChallenge design 1:1
 * (pointer-following spotlight between two cards, defaults to "The
 * Solution"); content drawn from the old bespoke CaseHero/CaseGallery copy.
 *
...
const cards: Card[] = [
  {
    title: "The Challenge",
    body: "Turn a traditional corporate logistics website into a premium lead-generation platform — covering dozens of services and industries — without losing the trust a decades-long legacy carries.",
    icon: "/figma/am-challenge-puzzle.svg",
    iconSize: "size-7",
  },
  {
    title: "The Solution",
    body: "A restructured, SEO-led website with a clear sitemap, conversion-focused content and a streamlined user journey, so visitors can find the right service and get in touch with confidence.",
...
export default function BvcChallenge() {
        ...
        <div className="mx-auto flex max-w-[900px] flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            <h2 className="text-[34px] font-semibold leading-[1.1] tracking-[-1.6px] text-[#1a1a1a] sm:text-[46px] sm:tracking-[-2.2px] lg:text-[64px] lg:leading-[72px] lg:tracking-[-3.6px]">
              From Legacy Website To Lead Generation Platform
            </h2>
            <p className="max-w-[640px] text-[16px] font-normal leading-[1.5] tracking-[-0.4px] text-black/60 lg:text-[18px] lg:tracking-[-0.48px]">
              BVC Logistics leads secure global logistics for gems, jewellery
              and other high-value cargo — the website needed to match that
              authority.
            </p>
          </div>
        </div>
