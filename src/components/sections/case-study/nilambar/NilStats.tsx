...
/**
 * NilStats — Nilambar case study, two stacked bands. Clones the RitvaaStats
 ...
 *     tracking -0.16px. All four Nilambar values are text (Client / Industry /
...
type Stat = {
  ...
  value: string;
  /** true when a gold "+" follows the value — no Nilambar stat uses it. */
  plus?: boolean;
  label: string;
};

const STATS: Stat[] = [
  { value: "Nilambar", label: "Client" },
  { value: "Real Estate & Advisory", label: "Industry" },
  { value: "Corporate Website", label: "Type" },
  { value: "Credibility & Inquiries", label: "Goal" },
];
...
export default function NilStats() {
  return (
    <section aria-labelledby="nil-stats-heading" className="w-full bg-white">
      <div className="mx-auto w-full max-w-[1200px] px-6 py-16 lg:px-10 lg:py-24">
        ...
        <figure className="mt-20 flex w-full flex-col items-center gap-6 text-center lg:mt-32">
          ...
          <blockquote className="mx-auto w-full max-w-[1065px] text-[#0a0a0a] text-[26px] leading-[36px] tracking-[-0.4px] sm:text-[32px] sm:leading-[46px] lg:text-[40px] lg:leading-[56px] lg:tracking-[-0.6px]">
            A brand broad enough to hold every venture, and focused enough to
            trust.
          </blockquote>
