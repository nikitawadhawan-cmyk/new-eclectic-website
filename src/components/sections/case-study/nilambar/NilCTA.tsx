/**
 * NilCTA — "Ready For Similar Results?" CTA on the Nilambar case-study
 * page. Clone of RitvaaCTA (itself cloned from AmoradaCTA, Figma node
 * 216:4845) with Nilambar content.
 *
 ...
 * public/figma/nil-hero.jpg laid as an absolutely-positioned <img>
 * with the navy tint + live text over it. Uses assetPath() for the raw
 * <img> (GitHub Pages basePath).
 *
 * DEVIATIONS (flagged in report):
 *  - IMAGE REUSE: nil-hero.jpg is the THIRD use of the only wide photo on
 *    the live Nilambar site (also the hero centre and the showcase) — no
 *    collage/banner asset exists for Nilambar; it sits under the same navy
 *    tint per spec.
...
export default function NilCTA() {
  return (
    <section className="w-full py-8 lg:py-12">
      <div className="mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-10">
        <div className="relative overflow-hidden rounded-[28px] lg:rounded-[47px]">
          {/* Background photo (nil-hero.jpg — reused site-wide; only wide photo) */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src={assetPath("/figma/nil-hero.jpg")}
            alt=""
            aria-hidden="true"
