...
/**
 * NilProjects — "MORE WORK" project showcase on the Nilambar case-study
 * page. Clone of RitvaaProjects (itself cloned from AmoradaProjects,
 * Figma: file Gf61npUa7cN0kaGb5RgSwe, node 203:1293) with Nilambar-specific
 ...
 * then TWO project blocks (Ivylistic, amorada). Each block: title, two
 ...
 *   - Both blocks link to REAL case-study routes (/projects/ivylistic,
 *     /projects/amorada) — title and round arrow button are wrapped in
 *     next/link Links (house pattern; basePath handled automatically).
 *   - Ivylistic stat chip LABELS ("Admissions Tracks", "Evaluation
 *     Response") are (glue) — connective copy not in the client HTML.
 */
...
const PROJECTS: Project[] = [
  {
    ...
    year: "2026",
    main: "/figma/ivy-og.jpg",
    mainAlt:
      "Ivylistic brand website — strategy-led admissions consulting hero",
    thumbs: [
      {
        src: "/figma/ivy-team.jpg",
        alt: "Ivylistic website — admissions consulting team",
      },
      {
        src: "/figma/ivy-1.jpg",
        alt: "Ivylistic website — higher-education guidance imagery",
      },
    ],
    description:
      "A strategy-led admissions brand — higher education, simplified.",
    stats: [
      { value: "MBA · MiM · MS", label: "Admissions Tracks" },
      { value: "24h", label: "Evaluation Response" },
    ],
  },
  {
    title: "amorada",
...
export default function NilProjects() {
  return (
    <section
      aria-labelledby="nilambar-projects-heading"
