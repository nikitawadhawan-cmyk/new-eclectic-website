...
/**
 * NilResults — "The Results" spotlight-split for the Nilambar case study
 ...
 *    heading, supporting line. NOTE: the heading ("What the corporate site
 *    delivers") and supporting line ("One brand, a proven portfolio, and
 *    qualified inquiries.") are GLUE text not present in the client's
 ...
 * verbatim from the spec (curly quotes kept in the "we're with you all the
 * way" line).
 */
...
const RESULTS: Result[] = [
  {
    kicker: "01 · MULTI-SERVICE BRAND",
    title: "Unified",
    desc: "Built the “we're with you all the way” voice so a multi-service firm reads as one trustworthy partner.",
  },
  {
    kicker: "02 · PROJECT PORTFOLIO",
    title: "Showcased",
    desc: "Showcased Renaissance, Vista, Elite and Meadows as proof of a real, deliverable track record.",
  },
  {
    kicker: "03 · LEAD CAPTURE",
    title: "Inquiry-Ready",
    desc: "A service-aware inquiry form that routes and qualifies leads.",
  },
];

export default function NilResults() {
      ...
      <div className="mx-auto grid w-full max-w-[1200px] grid-cols-1 items-start gap-12 px-6 lg:grid-cols-[minmax(280px,360px)_1fr] lg:gap-[clamp(40px,5vw,72px)] lg:px-10">
        ...
        <div className="flex flex-col gap-6 lg:sticky lg:top-[100px]">
          ...
          <h2 className="text-pretty font-semibold leading-[1.15] tracking-[-0.6px] text-[#0e1330] text-[32px] lg:text-[44px]">
            What the corporate site delivers
          </h2>
          <p className="max-w-[36ch] text-pretty text-[16px] leading-[1.6] text-[#6b7086]">
            One brand, a proven portfolio, and qualified inquiries.
          </p>
        </div>
