...
/**
 * NilChallenge — "WHY NILAMBAR" section for the Nilambar case study
 * (clone of RitvaaChallenge; identical design/structure/classes/animation,
 * Nilambar content per .figma-to-website/nilambar-case-study/spec.md):
 *
 ...
 *
 * Heading "We're With You All The Way" is the client's real tagline (from
 * the site HTML), and the subheading is verbatim from the client copy — no
 * glue text in this section.
 *
...
const cards: Card[] = [
  {
    title: "The Challenge",
    body: "Present a firm that does many things — construction, liaisoning, asset management, startup investment — without feeling scattered, and turn a broad audience into qualified inquiries.",
    icon: "/figma/am-challenge-puzzle.svg",
    iconSize: "size-7",
  },
  {
    title: "The Solution",
    body: "A structured corporate site with a clear services architecture, a project-portfolio showcase, a startup-investment section and a service-aware inquiry form — all under one aspirational “we're with you all the way” brand.",
...
export default function NilChallenge() {
