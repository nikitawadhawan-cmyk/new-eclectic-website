/**
 * TtgHighlights — "SERVICES PROVIDED / What drove this project" bento grid
 * (cloned from RitvaaHighlights, itself from AmoradaHighlights: redesigned
 * from a supplied dark bento reference, kept on the site's WHITE background
 * per client direction). Trippy Tour Guide content swapped in per the TTG
 * spec.
 *
 ...
 * transitions. Copy is verbatim from the TTG spec (curly quotes kept
 * exactly).
 */
...
const CARDS: Card[] = [
  {
    ...
    desc: "A vibrant, discovery-led experience across every destination.",
  },
  {
    title: "Website Development",
    desc: "A fast, responsive, multi-language build for a global audience.",
  },
  {
    title: "Catalogue & Commerce",
    desc: "120+ tours and bundles, structured to browse and to buy.",
  },
  {
    title: "Conversion Optimization",
    desc: "Two goals per page: tour purchase and app install.",
  },
  {
    title: "App Marketing",
    desc: "Clear “how it works” and download flows for iOS and Android.",
  },
];
...
export default function TtgHighlights() {
  return (
