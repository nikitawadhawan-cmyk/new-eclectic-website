...
/**
 * TtgStats — Trippy Tour Guide case study, two stacked bands. Clones the
 * RitvaaStats / AmoradaStats design 1:1 (same structure, classes, type
 * scale); only the content differs.
 *
 * (a) STATS BAND
...
type Stat = {
  ...
  value: string;
  /** true when a gold "+" follows the value — no TTG stat uses it. */
  plus?: boolean;
  label: string;
};
...
export default function TtgStats() {
  return (
    <section aria-labelledby="ttg-stats-heading" className="w-full bg-white">
      <div className="mx-auto w-full max-w-[1200px] px-6 py-16 lg:px-10 lg:py-24">
        ...
        <figure className="mt-20 flex w-full flex-col items-center gap-6 text-center lg:mt-32">
          ...
          <blockquote className="mx-auto w-full max-w-[1065px] text-[#0a0a0a] text-[26px] leading-[36px] tracking-[-0.4px] sm:text-[32px] sm:leading-[46px] lg:text-[40px] lg:leading-[56px] lg:tracking-[-0.6px]">
            A website that makes you want to book a flight &mdash; then hands you
            the guide.
          </blockquote>
