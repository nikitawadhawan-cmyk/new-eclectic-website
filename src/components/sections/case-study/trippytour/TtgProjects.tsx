...
/**
 * TtgProjects — "MORE WORK" project showcase on the Trippy Tour Guide
 * case-study page. Clone of RitvaaProjects (itself a clone of
 * AmoradaProjects, Figma: file Gf61npUa7cN0kaGb5RgSwe, node 203:1293)
 * with Trippy Tour Guide-specific content per the rebuild spec.
 *
 ...
 * then TWO project blocks (Peak Mode On, amorada). Each block: title, two
 ...
 *   - The HTML's first "More Work" card was "Ivylistic" — no Ivylistic page
 *     exists on this site, so it is SUBSTITUTED with Peak Mode On per spec.
 *   - Peak Mode On stat-chip labels ("Full Store / Ground-Up Build",
 *     "Dosha Quiz / Custom Integration") are glue copy not present in the
 *     client HTML — kept exactly as written in the spec.
...
const PROJECTS: Project[] = [
  {
    ...
    mainAlt:
      "Peak Mode On Shopify store — Ayurvedic wellness storefront banner",
    thumbs: [
      {
        src: "/figma/pmo-hero-1.jpg",
        alt: "Peak Mode On store — Ayurvedic wellness product imagery",
      },
      {
        src: "/figma/pmo-hero-2.jpg",
        alt: "Peak Mode On store — wellness lifestyle detail",
      },
    ],
    description:
      "A complete Ayurvedic wellness store built from the ground up on Shopify — with a custom Dosha quiz and educational content that guides first-time buyers.",
    stats: [
...
export default function TtgProjects() {
  return (
    <section
      aria-labelledby="ttg-projects-heading"
