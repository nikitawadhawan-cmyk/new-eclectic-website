/**
 * TtgCTA — "Ready For Similar Results?" CTA on the Trippy Tour Guide
 * case-study page. Clone of RitvaaCTA (itself a clone of AmoradaCTA,
 * Figma node 216:4845) with Trippy Tour Guide content.
 *
 ...
 *
 * ASSET APPROACH: background is the SINGLE destination photo
 * public/figma/ttg-bundle-4.jpg laid as an absolutely-positioned <img>
 * with the navy tint + live text over it. Uses assetPath() for the raw
 * <img> (GitHub Pages basePath).
 *
 * DEVIATIONS (flagged in report):
 *  - No photo-grid collage asset exists for Trippy Tour Guide (amorada uses
 *    am-cta-collage.jpg); a single photo (ttg-bundle-4.jpg) sits under the
...
export default function TtgCTA() {
  return (
    <section className="w-full py-8 lg:py-12">
      <div className="mx-auto w-full max-w-[1500px] px-4 sm:px-6 lg:px-10">
        <div className="relative overflow-hidden rounded-[28px] lg:rounded-[47px]">
          {/* Background photo (single destination photo — no collage asset for TTG) */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src={assetPath("/figma/ttg-bundle-4.jpg")}
            alt=""
            aria-hidden="true"
