...
/**
 * TtgHero — hero for the Trippy Tour Guide case-study page. Clones the
 * RitvaaHero / AmoradaHero design 1:1 (same structure, classes, animations);
 * only the content differs.
 *
 * Big uppercase "A GUIDE IN YOUR POCKET" heading → "— Case Study — Website
 * Design & Development —" subhead → a row of three destination images (two
 * shots flanking the featured destination, which is framed with violet
 * corner brackets, per the amorada design) → intro paragraph → navy "View
 * Live Website" pill button with a circular arrow badge.
 *
...
const HERO_IMAGES: HeroImage[] = [
  {
    src: "/figma/ttg-bundle-1.jpg",
    alt: "Sydney harbour skyline at sunset — a Trippy Tour Guide destination",
  },
  {
    src: "/figma/ttg-bundle-2.jpg",
    alt: "Featured Trippy Tour Guide destination",
    accent: true,
  },
  {
    src: "/figma/ttg-city.jpg",
    alt: "City destination on the Trippy Tour Guide website",
  },
];
...
export default function TtgHero() {
  return (
    <section className="w-full bg-white">
      <div className="mx-auto w-full max-w-[1200px] px-6 py-16 lg:px-10 lg:py-24">
        ...
        <p className="mx-auto mt-10 max-w-[641px] text-center text-[16px] font-normal leading-[24px] tracking-[-0.32px] text-[rgba(33,33,33,0.7)] lg:mt-14">
          Trippy Tour Guide turns any phone into a personal guide &mdash; GPS-activated,
          self-guided audio tours across 50+ destinations. We built the website that helps
          travellers discover tours, understand the app, and explore the world at their own pace.
        </p>

        {/* View Live Website button */}
        <div className="mt-8 flex justify-center">
          <a
            href="https://trippytourguide.com/en"
            target="_blank"
