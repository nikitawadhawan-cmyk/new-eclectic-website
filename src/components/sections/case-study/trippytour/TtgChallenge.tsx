...
/**
 * TtgChallenge — "WHY TRIPPY TOUR GUIDE" section for the Trippy Tour Guide
 * case study (clone of RitvaaChallenge; identical design/structure/classes/
 * animation, TTG content per .figma-to-website/trippy-tour-case-study/
 * spec.md):
 *
 ...
 *
 * NOTE: the heading "Selling Travel You Can't Touch" is GLUE text not
 * present in the client's source HTML — needs client review. The subheading
...
const cards: Card[] = [
  {
    title: "The Challenge",
    body: "Sell an intangible, try-before-you-travel product — self-guided audio tours — across 50+ cities, and drive both app installs and tour purchases from a single site.",
    icon: "/figma/am-challenge-puzzle.svg",
    iconSize: "size-7",
  },
  {
    title: "The Solution",
    body: "A vibrant, discovery-led website that showcases destinations and themed tours, explains GPS-activated offline audio in seconds, surfaces bundle savings, and drives app downloads — in multiple languages.",
...
export default function TtgChallenge() {
        ...
        <div className="mx-auto flex max-w-[900px] flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            <h2 className="text-[34px] font-semibold leading-[1.1] tracking-[-1.6px] text-[#1a1a1a] sm:text-[46px] sm:tracking-[-2.2px] lg:text-[64px] lg:leading-[72px] lg:tracking-[-3.6px]">
              Selling Travel You Can&rsquo;t Touch
            </h2>
            <p className="max-w-[640px] text-[16px] font-normal leading-[1.5] tracking-[-0.4px] text-black/60 lg:text-[18px] lg:tracking-[-0.48px]">
              Trippy Tour Guide turns any phone into a personal guide &mdash;
              GPS-activated, self-guided audio tours across 50+ destinations.
            </p>
          </div>
        </div>
