...
/* Trophy — designed Figma icon (node 17:700), navy */
function TrophyIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 23.9679"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-hidden="true"
      className={className}
...
/* Outgoing arrow — small designed mark used on the "Available For Work" card (node 17:802) */
      ...
      <div className="mx-auto w-full max-w-[1200px] px-6 lg:px-10">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-[640px]">
            ...
            <h2 className="mt-4 text-[40px] font-medium leading-[1.1] tracking-[-1.5px] text-black lg:text-[60px] lg:leading-[72px]">
              We Strive to Innovate
            </h2>
            <p className="mt-6 max-w-[532px] text-[16px] leading-[24px]">
          ...
          <a
            href="#contact"
            className="inline-flex h-12 w-fit shrink-0 items-center justify-center gap-2 rounded-full bg-navy px-6 text-[16px] font-semibold text-white transition-colors hover:bg-navy-deep"
          >
            <span>
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Quote + 92% */}
            <div className={`${cardBase} flex flex-1 flex-col justify-between px-6 py-6`}>
              <div>
                <QuoteIcon className="size-8" />
                <p className="mt-6 max-w-[360px] text-[20px] font-medium leading-[24px] text-black">
                  Our platform feels faster, smoother, and just works better and
                  intuitively. The engagement metrics don&rsquo;t lie.
                </p>
              </div>
              <div className="mt-10">
                <p className="text-[52px] font-semibold leading-[62px] tracking-[-2.15px] text-navy">
                  92<span className="text-[#e8c700]">%</span>
                </p>
                <p className="mt-1 text-[16px] leading-[24px] text-[#999]">
                  Client Satisfaction
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4">
            {/* Helmet render */}
            <div className="flex flex-1 items-center justify-center overflow-hidden rounded-2xl border border-black/10 bg-[#f3f3f5]">
              <Image
                src="/figma/innovate-helmet.png"
                alt="Close-up of a person wearing a white helmet with a large golden visor and a high-collared white jacket"
                width={992}
                height={1056}
            ...
            {/* 20+ dark band */}
            <div className="flex items-center justify-between gap-4 rounded-2xl border border-black/10 bg-navy px-6 py-5">
              <div>
                <p className="text-[36px] font-semibold leading-[43px] tracking-[-2.15px] text-white">
                  20<span className="text-[#e8c700]">+</span>
                </p>
                <p className="mt-1 text-[14px] leading-[21px] text-white">
          ...
          <div className="flex flex-col gap-4 md:col-span-2 lg:col-span-1">
            {/* Trusted + 5K+ */}
            <div className={`${cardBase} flex flex-1 flex-col justify-between px-6 py-6`}>
              <p className="max-w-[360px] text-[20px] font-medium leading-[24px] text-black">
                <span className="text-navy">T</span>rusted by E-commerce and B2B
            ...
            <a
              href="#contact"
              className={`${cardBase} flex items-center justify-between gap-4 px-6 py-5 transition-colors hover:bg-neutral-50`}
            >
